 ...
 * @author Asif Ruhani
 */
public class ProductOperation extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ProductOperation
     */
    ...
    public ProductOperation(String msg1) {
        initComponents();
        ...
        try{
           pst = con.prepareStatement("SELECT * FROM product WHERE P_ID=?");
               ...
               rs = pst.executeQuery();
               if(rs.next()){
                 txtP_ID.setText(rs.getString(1));
                 txtName.setText(rs.getString(2));
                 txtMfgDate.setText(rs.getString(3));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtP_ID, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        rs = pst.executeQuery();
          ...
          int scaledWidth = 162; // Set the desired width
          int scaledHeight = 182; // Set the desired height
          Image scaledImage = image.getScaledInstance(scaledWidth, scaledHeight, Image.SCALE_SMOOTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductOperation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
